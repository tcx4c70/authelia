...
var Keys = []string{
	...
	"server.endpoints.rate_limits.openid_connect_introspection.buckets",
	"server.endpoints.rate_limits.openid_connect_introspection.buckets[].period",
	"server.endpoints.rate_limits.openid_connect_introspection.buckets[].requests",
	"server.endpoints.rate_limits.openid_connect_introspection.enable",
	"server.endpoints.rate_limits.openid_connect_pushed_authorization_request.buckets",
	"server.endpoints.rate_limits.openid_connect_pushed_authorization_request.buckets[].period",
	"server.endpoints.rate_limits.openid_connect_pushed_authorization_request.buckets[].requests",
	"server.endpoints.rate_limits.openid_connect_pushed_authorization_request.enable",
	"server.endpoints.rate_limits.openid_connect_revocation.buckets",
	"server.endpoints.rate_limits.openid_connect_revocation.buckets[].period",
	"server.endpoints.rate_limits.openid_connect_revocation.buckets[].requests",
	"server.endpoints.rate_limits.openid_connect_revocation.enable",
	"server.endpoints.rate_limits.openid_connect_token.buckets",
	"server.endpoints.rate_limits.openid_connect_token.buckets[].period",
	"server.endpoints.rate_limits.openid_connect_token.buckets[].requests",
	"server.endpoints.rate_limits.openid_connect_token.enable",
	"server.endpoints.rate_limits.openid_connect_userinfo.buckets",
	"server.endpoints.rate_limits.openid_connect_userinfo.buckets[].period",
	"server.endpoints.rate_limits.openid_connect_userinfo.buckets[].requests",
	...
	"server.endpoints.rate_limits.second_factor_password.buckets",
	"server.endpoints.rate_limits.second_factor_password.buckets[].period",
	"server.endpoints.rate_limits.second_factor_password.buckets[].requests",
	...
	"telemetry.logs.exporter.grpc.endpoint",
	"telemetry.logs.exporter.grpc.insecure",
	"telemetry.logs.exporter.http.endpoint",
	"telemetry.logs.exporter.http.insecure",
	"telemetry.logs.exporter.http.path",
	...
	"telemetry.traces.exporter.grpc.endpoint",
	"telemetry.traces.exporter.grpc.insecure",
	"telemetry.traces.exporter.http.endpoint",
	"telemetry.traces.exporter.http.insecure",
	"telemetry.traces.exporter.http.path",
	"theme",
	"totp.algorithm",
